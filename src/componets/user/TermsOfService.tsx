...
const TermsOfService: FC = () => {
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      <Text>
        この利用規約（以下，「本規約」といいます。）は，サービス名いれる（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </Text>
      {/* 第一条 */}
      <View>
        <Text>第1条（適用）</Text>
      ...
      <View>
        ...
        <Text>規約に違反したことがある者からの申請である場合</Text>
        <Text>その他，当社が利用登録を相当でないと判断した場合</Text>
      </View>
      {/* 第三条 */}
      <View>
        <Text>第3条（メールアドレスおよびパスワードの管理）</Text>
        <Text>
      ...
      <View>
        ...
        <Text>5.本サービスによって得られた情報を商業的に利用する行為</Text>
        <Text>6.当社のサービスの運営を妨害するおそれのある行為</Text>
        <Text>7.不正アクセスをし，またはこれを試みる行為</Text>
        <Text>8.他のユーザーに関する個人情報等を収集または蓄積する行為</Text>
        <Text>9.不正な目的を持って本サービスを利用する行為</Text>
        <Text>
          10.本サービスの他のユーザーまたはその他の第三者に不利益，損害，不快感を与える行為
        </Text>
        <Text>11.他のユーザーに成りすます行為</Text>
        <Text>
          12.当社が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為
        </Text>
        <Text>13.面識のない異性との出会いを目的とした行為</Text>
        <Text>
          14.当社のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為
        </Text>
        <Text>15.その他，当社が不適切と判断する行為</Text>
      </View>
      {/* 第六条 */}
      <View>
        <Text>第6条（本サービスの提供の停止等）</Text>
        <Text>
      ...
      <View>
        ...
        <Text>金等の支払債務の不履行があった場合</Text>
        <Text>社からの連絡に対し，一定期間返答がない場合</Text>
        <Text>本サービスについて，最終の利用から一定期間利用がない場合</Text>
